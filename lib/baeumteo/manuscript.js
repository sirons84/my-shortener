...
export function makeWorld(config, stageIndex) {
  ...
  return {
    stageIndex,
    stage,
    player: { x: stage.start.x, y: stage.start.y, face: 0, moving: false },
...
export function onCaught(world) {
  ...
  world.player = { x: world.stage.start.x, y: world.stage.start.y, face: 0, moving: false };
  world.seen = 0;
  world.caught += 1;
